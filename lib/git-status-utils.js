...
(function() {
  ...
  module.exports = GitStatusUtils = (function() {
    ...
    GitStatusUtils._parseGitStatus = function(rawOutput) {
      var affix, branch, commitCount, commitsOff, currentFileBlock, fileBlock, i, isNewFileBlock, j, len, len1, line, lines, match, matches, ofWith, ref, ref1, ref2, ref3, remote, status, statusOut;
      ...
      for (i = 0, len = ref1.length; i < len; i++) {
        ...
        ref2 = this.FILE_BLOCKS;
        for (j = 0, len1 = ref2.length; j < len1; j++) {
          fileBlock = ref2[j];
          if (((ref3 = line.match(fileBlock.match)) != null ? ref3.length : void 0) > 0) {
